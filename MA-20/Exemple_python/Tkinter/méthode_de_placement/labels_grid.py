...
# Title
Label(text="Placement labels par .grid",width=25, height=3,  font=("Arial", 15)).grid(row=0,column=0, columnspan=2,padx=10,pady=10)
...
for line in range(len(words)):
    for col in range(len(words[line])):
        ...
        labels[line][col] = Label (win, text =words[line][col], width=15, height=7, borderwidth=1, relief="solid", font=("Arial", 15), bg="#FFFF00")
