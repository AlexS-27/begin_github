...
def afficher_message():
    ...
    label_message.config(text=f"Bonjour {prenom} {nom} vous aurez {age} ans en 2025")
    # label_message.config(text = "Bonjour " + prenom + " " + nom +"vous aurez " + age +"en 2025")
...
label_year = tk.Label(root, text="Age :")
