...
entry_max.insert(0, "100")  # Valeur par défaut pour max

# Boutons pour calculer
btn_calculate = tk.Button(root, text="Triangles rect entier", command=find_triangle_rect_entier)
btn_calculate.grid(row=2, column=0,  pady=10)
btn_calculate_smart = tk.Button(root, text="Traingles rect ent smart", command=find_triangle_rect_smart)
btn_calculate_smart.grid(row=2, column=1,  pady=10)
btn_calculate_prim = tk.Button(root, text="Triangle rect primitifs" , command= find_triangle_primitif)
